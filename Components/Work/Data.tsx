export const workData = [
  {
    ...
    work: [
      "Hands-on experience with front-end technologies such as HTML5, CSS3 and JavaScript",
      "Familiarity with libraries like Axios, React Router, and Bootstrap for styling.",
      "Proficiency in version control tools like Git and collaborative tools like GitHub for code management.",
    ],
  },
  {
    id: 1,
    designation: "Node Js Developer",
    companyName: " @ Stroke Infotech",
    duration: "May 2022  - Jun-2022",
    work: [
      "Worked on projects involving Node.js, Express.js, MongoDB, and Socket.io.",
      "Develop the backend infrastructure and API for the platform",
      "Ability to work with MongoDB and Mongoose ORM for database management.",
      "Worked with the front-end developers to ensure that the API endpoints were designed to meet the needs of the user interface.",
    ],
  },
  {
    id: 2,
    ...
    work: [
      ...
      "Worked closely with the agency's marketing team and UX/UI team to ensure platform met requirements and was visually appealing and easy to use.",
      "Integrated Invoice processing and developed system for tracking and reporting on payment transactions.",
      "Collaborated with cross-functional teams, including the backend team and product manager, utilizing JIRA SDLC for efficient project delivery and meet the deadlines.",
    ],
  },
  {
    id: 3,
